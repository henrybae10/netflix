					...
					<TvsSection>
						<Slider>
							<AnimatePresence
								...
								<TvSectionTitle>- Latest Tv</TvSectionTitle>
								<Row
						...
						<Slider>
							<AnimatePresence
								initial={false}
								onExitComplete={toggleLeaving}>
								<TvSectionTitle>- popular tv</TvSectionTitle>
								<Row
									variants={rowVariants}
									initial="hidden"
									animate="visible"
						...
						<Slider>
							<AnimatePresence
								initial={false}
								onExitComplete={toggleLeaving}>
								<TvSectionTitle>- top rated tv</TvSectionTitle>
								<Row
									variants={rowVariants}
									initial="hidden"
									animate="visible"
...
const TvSectionTitle = styled.h3`
	margin: 10px;
	color: ${(props) => props.theme.white.lighter};
	font-size: 30px;
`;
